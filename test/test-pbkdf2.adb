...
use Crypto.Symmetric.KDF_PBKDF2;
...
------------------------------------------------------------------------------------
   ...
   package S5C renames Crypto.Symmetric.KDF_PBKDF2;
...
------------------------------------------------------------------------------------
   ...
   begin
      success := Crypto.Symmetric.KDF_PBKDF2.Initialize(Parameter => 1);
      Derive(Salt     => "salt",
             Password => "password",
      ...
      Assert(Twenty_Bytes_Container(0..19)=(16#0c#, 16#60#, 16#c8#, 16#0f#, 16#96#, 16#1f#, 16#0e#, 16#71#,
             				    ...
             				    16#2f#, 16#e0#, 16#37#, 16#a6#), "PBKDF2 failed.");

      success := Crypto.Symmetric.KDF_PBKDF2.Initialize(Parameter => 2);
      Derive(Salt     => "salt",
             Password => "password",
             Key      => Twenty_Bytes_Container,
             DK_Len   => 20);
      ...
      Assert(Twenty_Bytes_Container(0..19)=(16#ea#, 16#6c#, 16#01#, 16#4d#, 16#c7#, 16#2d#, 16#6f#, 16#8c#,
             				   ...
             				   16#d8#, 16#de#, 16#89#, 16#57#), "PBKDF2 failed.");


      success := Crypto.Symmetric.KDF_PBKDF2.Initialize(Parameter => 4096);
      Derive(Salt     => "salt",
             Password => "password",
             Key      => Twenty_Bytes_Container,
             DK_Len   => 20);
      ...
      Assert(Twenty_Bytes_Container(0..19)=(16#4b#, 16#00#, 16#79#, 16#01#, 16#b7#, 16#65#, 16#48#, 16#9a#,
             				    ...
             				    16#65#, 16#a4#, 16#29#, 16#c1#), "PBKDF2 failed.");

      success := Crypto.Symmetric.KDF_PBKDF2.Initialize(Parameter => 4096);
      Derive(Salt     => "saltSALTsaltSALTsaltSALTsaltSALTsalt",
