...
package body Test.TDES_Obsolete is
   use Crypto.TypeS;
...
------------------------------------------------------------------------------------
	...
	begin
		Register_Routine(T, TDES_Obsolete_Test1'Access,"TDES_Obsolete_Test1.");
		Register_Routine(T, TDES_Obsolete_Test2'Access,"TDES_Obsolete_Test2.");
		Register_Routine(T, TDES_Obsolete_Test3'Access,"TDES_Obsolete_Test3.");
	end Register_Tests;
...
------------------------------------------------------------------------------------
   ...
   procedure TDES_Obsolete_Test1(T : in out Test_Cases.Test_Case'Class) is
   ...
   end TDES_Obsolete_Test1;

------------------------------------------------------------------------------------
-------------------------------------- Test 2 --------------------------------------
------------------------------------------------------------------------------------

   procedure TDES_Obsolete_Test2(T : in out Test_Cases.Test_Case'Class) is
      use AUnit.Assertions; 
      use Crypto.Symmetric.Blockcipher_Tripledes;
   begin
   ...
   end TDES_Obsolete_Test2;

------------------------------------------------------------------------------------
-------------------------------------- Test 3 --------------------------------------
------------------------------------------------------------------------------------

   procedure TDES_Obsolete_Test3(T : in out Test_Cases.Test_Case'Class) is
      use AUnit.Assertions; 
      use Crypto.Symmetric.Blockcipher_Tripledes;
   begin
