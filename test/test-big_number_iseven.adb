...
package body Test.Big_Number_IsEven is
   ...
   begin
      ...
      Register_Routine(T, Big_Number_Test1'Access,"Is Even with 4096 Bit");
      Register_Routine(T, Big_Number_Test2'Access,"Is Even with 1025 Bit");
      Register_Routine(T, Big_Number_Test3'Access,"Is Even with 1024 Bit");
      Register_Routine(T, Big_Number_Test4'Access,"Is Even with 768 Bit");
      Register_Routine(T, Big_Number_Test5'Access,"Is Even with 1 Bit");
      Register_Routine(T, Big_Number_Test6'Access,"Is Even with 0 Bit");
      end Register_Tests;
