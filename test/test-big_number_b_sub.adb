...
package body Test.Big_Number_B_Sub is
...
------------------------------------------------------------------------------------
	...
	begin
		...
		Register_Routine(T, Big_Number_Mod_Utils_Test1'Access,"B_Sub with Modulo N = 2^4096-1.");
		Register_Routine(T, Big_Number_Mod_Utils_Test2'Access,"B_Sub with Modulo N = 2^3812.");
		Register_Routine(T, Big_Number_Mod_Utils_Test3'Access,"B_Sub with Modulo N = 2^2048.");
		Register_Routine(T, Big_Number_Mod_Utils_Test4'Access,"B_Sub with Modulo N = 2^1025.");
		Register_Routine(T, Big_Number_Mod_Utils_Test5'Access,"B_Sub with Modulo N = 2^1024.");
		Register_Routine(T, Big_Number_Mod_Utils_Test6'Access,"B_Sub with Modulo N = 2^768.");
		Register_Routine(T, Big_Number_Mod_Utils_Test7'Access,"B_Sub with Modulo N = 2^0.");
