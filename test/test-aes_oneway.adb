...
package body Test.Aes_Oneway is
   ...
   begin
      Register_Routine(T, Aes_Oneway_Test1'Access,"AES192 Oneway Determinism Test");
      Register_Routine(T, Aes_Oneway_Test2'Access,"AES192 Oneway Known Answer Test");
   end Register_Tests;
   ...
   procedure Aes_Oneway_Test1(T : in out Test_Cases.Test_Case'Class) is
   ...
   begin
      ...
      Assert(Is_distinct = true, "AES192 Oneway Known Amswer Test failed");
   end Aes_Oneway_Test1;
   ...
   procedure Aes_Oneway_Test2(T : in out Test_Cases.Test_Case'Class) is
      use AUnit.Assertions;
      use Crypto.Symmetric.Algorithm.AES.Oneway;
      use Crypto.Types;
