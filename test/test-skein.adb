...
------------------------------------------------------------------------------------
   ...
   procedure Skein_Test_256(T : in out Test_Cases.Test_Case'Class) is
      ...
      Target_result_Short: Bytes(0..31) := 	(16#34#, 16#E2#, 16#B6#, 16#5B#, 16#F0#, 16#BE#, 16#66#, 16#7C#,
      ...
      Target_result: Bytes(0..31) := 		(16#8D#, 16#0F#, 16#A4#, 16#EF#, 16#77#, 16#7F#, 16#D7#, 16#59#,
      ...
      Target_result_long: Bytes(0..31) := 	(16#DF#, 16#28#, 16#E9#, 16#16#, 16#63#, 16#0D#, 16#0B#, 16#44#,
...
--        end loop;
      ...
      Assert(Finalresult_Short=Target_result_Short and then Finalresult=Target_result and then Finalresult_Long=Target_result_long, "Skein Test a)");
   ...
   procedure Skein_Test_512(T : in out Test_Cases.Test_Case'Class) is
      ...
      --Target for 1 Byte 16#00# Message data
      Target_result_Short: Bytes(0..63) :=  (16#40#, 16#28#, 16#5F#, 16#43#, 16#36#, 16#99#, 16#A1#, 16#D8#,
      ...
      Target_result: Bytes(0..63) :=  (16#45#, 16#86#, 16#3B#, 16#A3#, 16#BE#, 16#0C#, 16#4D#, 16#FC#,
      ...
      Target_result_long: Bytes(0..63) :=  (16#91#, 16#CC#, 16#A5#, 16#10#, 16#C2#, 16#63#, 16#C4#, 16#DD#,
   ...
   begin
      ...
      Mode := m512;		--result length in BITS
...
--        end loop;
   ...
   procedure Skein_Test_1024(T : in out Test_Cases.Test_Case'Class) is
      ...
      --Target for 1 Byte 16#00# Message data
      Target_result_Short: Bytes(0..127) :=  (16#CC#, 16#66#, 16#6D#, 16#D8#, 16#2A#, 16#8D#, 16#4D#, 16#A4#,
      ...
      Target_result: Bytes(0..127) :=       (16#1F#, 16#3E#, 16#02#, 16#C4#, 16#6F#, 16#B8#, 16#0A#, 16#3F#,
      ...
      Target_result_long: Bytes(0..127) :=  (16#84#, 16#2A#, 16#53#, 16#C9#, 16#9C#, 16#12#, 16#B0#, 16#CF#,
