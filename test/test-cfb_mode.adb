...
pragma Elaborate_All(Crypto.Symmetric.Mode.CFB);

package body Test.CFB_Mode is
use Crypto.Types;
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
------------------------------ Type - Declaration ------------------------------
...
--------------------------------------------------------------------------------
   ...
   package CFB is new Crypto.Symmetric.Mode.CFB(AES128);
   use CFB;
   ...
   -----------------------------------------------------------------------------
	...
	begin
		Register_Routine(T, CFB_Mode_Test1'Access,"CFB_Mode_Test1.");
	...
	begin
		return new String'("CFB_Mode Test");
	end Name;
   ...
   procedure CFB_Mode_Test1(T : in out Test_Cases.Test_Case'Class) is
