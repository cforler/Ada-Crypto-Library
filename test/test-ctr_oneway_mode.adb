...
pragma Elaborate_All(Crypto.Symmetric.Mode.Oneway_CTR);
pragma Elaborate_All(Crypto.Types);
  
package body Test.CTR_Oneway_Mode is
use Crypto.Types;
   -----------------------------------------------------------------------------
   -----------------------------------------------------------------------------
   ------------------------------ Type - Declaration ---------------------------
   ...
   package Oneway_CTR is new Crypto.Symmetric.Mode.Oneway_CTR(AES128);
   use Oneway_CTR;
   ...
   -----------------------------------------------------------------------------
   -----------------------------------------------------------------------------
   ---------------------- Register CTR_Oneway_Mode Test 1 ----------------------
   -----------------------------------------------------------------------------
   -----------------------------------------------------------------------------
   ...
   begin
      Register_Routine(T,CTR_Oneway_Mode_Test1'Access,"CTR_Oneway_Mode_Test1.");
   end Register_Tests;

   -----------------------------------------------------------------------------
   -----------------------------------------------------------------------------
   -------------------------- Name CTR_Oneway_Mode Test ------------------------
   -----------------------------------------------------------------------------
   -----------------------------------------------------------------------------

   function Name(T : Mode_Test) return Test_String is
   begin
      return new String'("CTR_Oneway_Mode Test");
   end Name;
   ...
   procedure CTR_Oneway_Mode_Test1(T : in out Test_Cases.Test_Case'Class) is
   ...
   end CTR_Oneway_Mode_Test1;
   
------------------------------------------------------------------------------------

end Test.CTR_Oneway_Mode;
