...
use Crypto.Types;
   ...
   begin
      ...
      Register_Routine(T,OFB_Oneway_Mode_Test2'Access,"OFB_Oneway_Mode_Test2.");
   end Register_Tests;
   ...
   procedure OFB_Oneway_Mode_Test2(T : in out Test_Cases.Test_Case'Class) is
      use AUnit.Assertions;
   begin
      Init(Key, IV);
      Set_IV(IV);
