...
with Crypto.Symmetric.Algorithm.Blake2b1Bla; use Crypto.Symmetric.Algorithm.Blake2b1Bla;
  ...
  package Crypto.Symmetric.Compress_Blake2b1Bla is

   type Blake2b1Bla_Scheme is new Crypto.Symmetric.Compress.Compress_Scheme with 
   record
     Ctx : Blake2b_Context;
   end record;
    ...
    overriding
  	...
  	overriding
  	function Get_Length(This     : in out Blake2b1Bla_Scheme) return Integer;
	
	overriding
  	procedure Reset(This     : in out Blake2b1Bla_Scheme);
