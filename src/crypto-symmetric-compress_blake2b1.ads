...
with Crypto.Symmetric.Algorithm.Blake2b1; use Crypto.Symmetric.Algorithm.Blake2b1;
  ...
  package Crypto.Symmetric.Compress_Blake2b1 is

   type Blake2b1_Scheme is new Crypto.Symmetric.Compress.Compress_Scheme with 
   record
     Ctx : Blake2b_Context;
   end record;
    ...
    overriding
  	...
  	overriding
  	function Get_Length(This     : in out Blake2b1_Scheme) return Integer;
