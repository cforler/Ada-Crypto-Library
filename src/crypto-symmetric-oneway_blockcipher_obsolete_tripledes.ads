...
package Crypto.Symmetric.Oneway_Blockcipher_Obsolete_Tripledes is
   new  Crypto.Symmetric.Oneway_Blockcipher
  (Block          => B_Block64,
   Key_Type       => B_Block192,
   Cipherkey_Type => Obsolete_Cipherkey_Oneway_TDES,
   Prepare_Key    => Obsolete_Prepare_Oneway_Key,
   Encrypt        => Obsolete_Encrypt_Oneway);
