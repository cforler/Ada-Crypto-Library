...
with Crypto.Types;
with Crypto.Symmetric.Algorithm.Blake2b;
with Crypto.Symmetric.Hashfunction;

use Crypto.Types;
use Crypto.Symmetric.Algorithm.Blake2b;


pragma Elaborate_All (Crypto.Symmetric.Hashfunction);
package Crypto.Symmetric.Hashfunction_Blake2b is
  new Crypto.Symmetric.Hashfunction
    (Hash_Type                 	=> DW_Block512,
     ...
     To_Message_Type            => To_DW_Block512);
