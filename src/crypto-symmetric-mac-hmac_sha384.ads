...
with Crypto.Symmetric.Hashfunction_SHA384;

pragma Elaborate_All (Crypto.Symmetric.Mac.Hmac);

package Crypto.Symmetric.Mac.Hmac_SHA384 is
   new  Crypto.Symmetric.Mac.Hmac(H      => Crypto.Symmetric.Hashfunction_SHA384,
