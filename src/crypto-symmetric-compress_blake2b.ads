...
with Crypto.Types; use Crypto.Types;
  ...
  package Crypto.Symmetric.Compress_Blake2b is

   type Blake2b_Scheme is new Crypto.Symmetric.Compress.Compress_Scheme with null record;
    ...
    overriding
  	...
  	overriding
  	function Get_Length(This     : in out Blake2b_Scheme) return Integer;
