...
package Crypto.Symmetric.Algorithm.SHA256.Oneway is

   type Cipherkey_SHA256 is private;
...
private
   ...
   type Cipherkey_SHA256 is record
      Left_Key  : W_Block128;
      Right_Key : W_Block128;
   end record;
