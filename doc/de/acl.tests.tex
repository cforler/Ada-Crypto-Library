...
\begin{figure}[htp]
\centering
%\includegraphics[width=\textwidth]{graph_aunit.pdf}
...
\begin{figure}[htp]
\centering
%\includegraphics[height=10 cm, width = 12 cm]{tabelle_gcov.png}
\caption{}
\label{}
\end{figure}
...
\begin{figure}[htp]
\centering
%\includegraphics[width=15 cm, height= 3 cm]{graph_suites.pdf}
